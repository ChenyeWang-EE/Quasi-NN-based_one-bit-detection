function [dLdReh,dLdImh,loss2] = GenGradient_SIMO_ISI_Channel_2(ResigVec,ImsigVec,Re_hMtr,Im_hMtr,label,xkMtr)
...
dRev_dReh = zeros(16,2,N);
dRev_dImh = zeros(16,2,N);
dImv_dReh = zeros(16,2,N);
dImv_dImh = zeros(16,2,N);
dLdReh = zeros(N,2);
dLdImh = zeros(N,2);
for n = 1 : N
    for ii = 1 : 2
...
da_dReh = zeros(16,2,N);
da_dImh = zeros(16,2,N);
for n = 1 : N
