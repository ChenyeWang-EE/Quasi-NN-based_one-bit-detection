function DecodeBit = QNN_viterbi_one_bit_SIMO_detection(zkVec,Re_hMtr,Im_hMtr)
%% upsample = 1;
% len = length(zk);
% yprob = zeros(8,8,len);
...
distanceMtr = QNN_distance_branch_one_bit_SIMO( zkVec,Re_hMtr,Im_hMtr); % numBits × 16 Matrix
