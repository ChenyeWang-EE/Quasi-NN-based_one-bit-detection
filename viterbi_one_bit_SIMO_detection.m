function DecodeBit = viterbi_one_bit_SIMO_detection(zkVec, channelH_Vec,noiseVar)
%% upsample = 1;
% len = length(zk);
% yprob = zeros(8,8,len);
...
% % test
BranchMetricMtr = distance_branch_one_bit_SIMO_L2( zkVec, channelH_Vec, noiseVar);
for i = 1 : numBits
