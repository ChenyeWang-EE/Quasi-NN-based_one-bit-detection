function [DecodeBit,DecodeSym]  = Viterbi_ISI_SIMO_L2_4QAM_inf_L3( ykVec,channelH_Vec)
...
numBits = size(ykVec,2);
% % test
BranchMetricMtr = distance_branch_SIMO_4QAM_inf_L3( ykVec, channelH_Vec);
for i = 1 : numBits
