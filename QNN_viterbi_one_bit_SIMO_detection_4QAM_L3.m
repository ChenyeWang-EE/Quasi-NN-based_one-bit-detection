function [DecodeBit,DecodeSym] = QNN_viterbi_one_bit_SIMO_detection_4QAM_L3(zkVec,Re_hMtr,Im_hMtr)
%% upsample = 1;
% len = length(zk);
% yprob = zeros(8,8,len);
...
% % test
BranchMetricMtr = QNN_distance_branch_one_bit_SIMO_4QAM_L3( zkVec,Re_hMtr,Im_hMtr);
for i = 1 : numBits
    ...
    BranchMetric = reshape( BranchMetricMtr(i,:), 4, 16).'; 
