function [DecodeBit,DecodeSym] = viterbi_one_bit_SIMO_4QAM_detection_L3(zkVec, channelH_Vec,noiseVar)
%% upsample = 1;
% len = length(zk);
% yprob = zeros(8,8,len);
...
% % test
BranchMetricMtr = distance_branch_SIMO_4QAM_L3( zkVec,channelH_Vec,noiseVar);
for i = 1 : numBits
